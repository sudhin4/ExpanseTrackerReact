  ...
  return (
    <>
      <div className="WHole_Heading_Div">
        <h2 className="LastTransaction_name_heading heading_last">
          Transaction name
        </h2>
        <h2 className="LastTransaction_Date_heading heading_last">Date</h2>
        <h2 className="LastTransaction_payment_mode_heading heading_last">
          Payment Type
        </h2>
        <h2 className="LastTransaction_category_heading heading_last">
          Category
        </h2>
    ...
    <>
      <div className="DaTE_lastTRANSACTION">
        ...
        <img
          src={Cash}
          alt=""
          className="PAYMENT_modeimage_for_lasttransaction"
        />
